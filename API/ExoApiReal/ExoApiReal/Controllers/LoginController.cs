...
namespace ExoApiReal.Controllers
{
    ...
    public class LoginController : ControllerBase
    {
        ...
        public IActionResult Login(LoginViewModel login)
        {
            ...
            var chave = new SymmetricSecurityKey(System.Text.Encoding.UTF8.GetBytes("exoapireal-chave-autenticacao"));

            var credenciais = new SigningCredentials(chave, SecurityAlgorithms.HmacSha256);

            var meuToken = new JwtSecurityToken(
                issuer: "exoapireal.webapi",
                audience: "exoapireal.webapi",
                claims: minhasClaims,
